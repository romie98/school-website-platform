        ...
        <div className="page-wrap">
          ...
          <article className="mx-auto grid max-w-4xl gap-10 lg:grid-cols-[240px_1fr]">
            <aside className="text-center">
              <img src={mediaUrl(principal.photoMedia) || mediaUrl(principal.photo)} alt={principal.name} className={`mx-auto h-72 w-56 object-cover ${heritage ? '' : 'rounded-lg shadow-[var(--shadow-card)]'}`} />
            ...
            <div className={`border-l-0 border-gold lg:pl-10 ${heritage ? 'lg:border-l-2' : 'lg:border-l-4'}`}>
              ...
              {principal.signatureImage && <img src={mediaUrl(principal.signatureImage)} alt="" className="mt-6 h-16 object-contain" />}
